...
const __u8 uclogic_rdesc_xppen_a22rp_pen_arr[] = {
	/* After running uclogic-probe */
	0x05, 0x0D,         /*  Usage Page (Digitizer),             */
	0x09, 0x02,         /*  Usage (Pen),                        */
	0xA1, 0x01,         /*  Collection (Application),           */
	0x85, 0x08,         /*      Report ID (8),                  */
	...
	0x46, 0x63, 0x23,   /*          Physical Maximum (9059),    */
	0x26, 0xE2, 0x59,   /*          Logical Maximum (23010),    */
	0x81, 0x02,         /*          Input (Variable),           */
	0x09, 0x31,         /*          Usage (Y),                  */
	0x46, 0xEA, 0x13,   /*          Physical Maximum (5098),    */
	0x26, 0x96, 0x32,   /*          Logical Maximum (12950),    */
	0x81, 0x02,         /*          Input (Variable),           */
	0xB4,               /*          Pop,                        */
	0x09, 0x30,         /*          Usage (Tip Pressure),       */
	...
	/*0x65, 0x13,                     [>          Unit (Inch),                    <]*/
	/*0x55, 0x0D,                     [>          Unit Exponent (13),             <]*/
	/*0x46, 0x3E, 0x49,               [>          Physical Maximum (18750),       <]*/
	/*0x27, 0x30, 0xBA, 0x00, 0x00,   [>          Logical Maximum (47664),        <]*/
	/*0x81, 0x02,                     [>          Input (Variable),               <]*/
	/*0x09, 0x31,                     [>          Usage (Y),                      <]*/
	/*0x46, 0x36, 0x29,               [>          Physical Maximum (10550),       <]*/
...
const size_t uclogic_rdesc_xppen_a22rp_pen_size =
			sizeof(uclogic_rdesc_xppen_a22rp_pen_arr);

/* Report descriptor template for XP-Pen Artist 15.6 Pro frame */
const __u8 uclogic_rdesc_xppen_a22rp_frame_arr[] = {
	0x05, 0x01,                     /*  Usage Page (Desktop),                   */
	0x09, 0x06,                     /*  Usage (Keyboard),                       */
	0xA1, 0x01,                     /*  Collection (Application),               */
	/*0x85, 0x06,                         Report ID (6),                      */
	0x85, UCLOGIC_RDESC_V1_FRAME_ID,/*    Report ID (Virtual report),         */
	0x05, 0x07,                     /*      Usage Page (Keyboard),              */
	0x19, 0xE0,                     /*      Usage Minimum (KB Leftcontrol),     */
	0x29, 0xE7,                     /*      Usage Maximum (KB Right GUI),       */
	0x15, 0x00,                     /*      Logical Minimum (0),                */
...
const size_t uclogic_rdesc_xppen_a22rp_frame_size =
			sizeof(uclogic_rdesc_xppen_a22rp_frame_arr);
